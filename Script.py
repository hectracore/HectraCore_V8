...
•─────•─────────•─────•
🏷️ <a href='https://t.me/muzxfir'>ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴘʀᴏᴏꜰ</a>
...
💳 ᴜᴘɪ ɪᴅ - <code>{https://files.catbox.moe/up9on1.png}</code>
...
💸 ᴜᴘɪ ɪᴅ → <code>{https://files.catbox.moe/up9on1.png}</code>  
📷 ǫʀ ᴄᴏᴅᴇ → <a href='{https://files.catbox.moe/up9on1.png}'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a>  
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/muzxfir'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
